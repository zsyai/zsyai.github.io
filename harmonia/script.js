    ...
    const Events = {
        ...
        init: () => {
            ...
            if (page === 'intranet') {
                ...
                document.getElementById('menu-toggle').addEventListener('click', Events.handleMenuToggle);
                document.getElementById('sidebar-overlay').addEventListener('click', Events.handleMenuToggle);
                ...
                document.getElementById('mode-toggle-button').addEventListener('click', Events.handleModeToggle);
